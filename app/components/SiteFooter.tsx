  ...
  return (
    <footer className="site-footer">
      <div className="shell footer-grid">
        ...
        <div className="footer-contact"><h2>Export sales</h2><a href="https://wa.me/8615621089573" target="_blank" rel="noreferrer">WhatsApp<br /><b>+86 156 2108 9573</b></a><a href="mailto:info@deesheng.food">info@deesheng.food</a><span>Qingdao, Shandong, China</span></div>
      </div>
