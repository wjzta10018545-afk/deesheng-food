...
export default function AboutPage() {
  const data = { "@context": "https://schema.org", "@type": "Organization", name: "Qingdao Deesheng Hengxin Food Co., Ltd.", alternateName: "Deesheng Food", url: "https://deesheng.food", email: "info@deesheng.food", telephone: "+86-156-2108-9573", address: { "@type": "PostalAddress", addressLocality: "Qingdao", addressRegion: "Shandong", addressCountry: "CN" } };
  return (
    <main>
      <JsonLd data={data} />
