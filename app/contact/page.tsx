...
export default function ContactPage() {
  const data = { "@context": "https://schema.org", "@type": "ContactPage", name: "Contact Deesheng Food Export Sales", mainEntity: { "@type": "Organization", name: "Qingdao Deesheng Hengxin Food Co., Ltd.", email: "info@deesheng.food", telephone: "+86-156-2108-9573", contactPoint: { "@type": "ContactPoint", contactType: "sales", telephone: "+86-156-2108-9573", email: "info@deesheng.food", availableLanguage: ["English", "Chinese"] } } };
  return (
    <main>
      <JsonLd data={data} />
      <section className="contact-hero shell"><div><p className="eyebrow">B2B export inquiry</p><h1>Tell us what you plan to buy.</h1><p>Product, pack, quantity, market and channel are the fastest route to a useful answer.</p></div><div className="contact-direct"><span>Direct export sales</span><a href="https://wa.me/8615621089573" target="_blank" rel="noreferrer"><small>WhatsApp / Tel</small><strong>+86 156 2108 9573</strong></a><a href="mailto:info@deesheng.food"><small>Email</small><strong>info@deesheng.food</strong></a><p>Deesheng Food export team<br />Qingdao, Shandong, China</p></div></section>
